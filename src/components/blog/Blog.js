      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="left-image">
            <NavLink to="/blog/ayuda-energia"><img src={img1} alt="Workspace Desktop" /></NavLink>
            <div class="info">
              <div class="inner-content">
                ...
                <NavLink to="/blog/ayuda-energia"><h4>Obtenga ayuda para pagar su estado de cuenta de energía de PG&E</h4></NavLink>
            ...
            <ul>
              <li>
                <div class="left-content align-self-center">
                  ...
                  <NavLink to="/blog/ahorro-de-cable"><h4>Descubre como ahorrar mas en tu factura de cable con mas beneficios!</h4></NavLink>
                  <Styleddesc>Deja de pagar bills altos por cable, disfruta de mas de 3k canales, series, peliculas, etc al precio ideal</Styleddesc>
                </div>
              ...
              <li>
                <div class="left-content align-self-center">
                  ...
                  <NavLink to="/blog/ahorro-de-cable"><h4>Que tan rapido es tu internet? mira por que todos escogen la fibra optica</h4></NavLink>
              ...
              <li>
                <div class="left-content align-self-center">
                  <span><i class="fa fa-calendar"></i>Marzo 2022</span>
                  <NavLink to="/blog/ayuda-facturas"><h4>Asistencia con el pago de bills o facturas</h4></NavLink>
